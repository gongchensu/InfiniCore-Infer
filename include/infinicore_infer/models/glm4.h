...
typedef struct
{
    ...
    // nlayer * [d]
    const void *const *self_attn_norm;
    // nlayer * [d]
    ...
    // nlayer * [d]
    const void *const *post_ffn_norm;
...
__C __export struct Glm4Model *
createGlm4Model(const Glm4Meta *,
                 const Glm4Weights *,
...
/// @brief 销毁模型
__C __export void
destroyGlm4Model(struct Glm4Model *);
...
__C __export void
inferBatchGlm4(struct Glm4Model *,
...
__C __export void
forwardBatchGlm4(struct Glm4Model *,
                  const uint32_t *tokens, uint32_t ntok,
                  const uint32_t *req_lens, uint32_t nreq, const uint32_t *req_pos,
                  struct KVCache **kv_caches,
                  void *logits);
